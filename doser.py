...
print("Скрипт для DOS. by ukrkillent ")
...
def main(argv):
	parser = argparse.ArgumentParser(description='Sending unlimited amount of requests in order to perform DoS attacks. Written by UkrKillent')
